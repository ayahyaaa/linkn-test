...
<div class="container">
    <div class="row justify-content-center">
        ...
        <img src="{{ asset('img/logo-shared-330x80.png') }}" alt="image" class="logo-arrangement my-lg-5">
        ...
        <div class="text-xl-end">
            <h6>powered by <a href="{{URL::to('https://qiwii.id/')}}"><img src="{{ asset('img/logo-qiwii.png') }}" alt="image" href="https://qiwii.id/" class="m-2 w-3 h-3"></a></h6>
        </div>
    </div>
</div>
@endsection